...
const template = "<style>:host{display:inline-flex;flex-direction:column;vertical-align:middle}.field{display:inline-block;outline:var(--outline, none);border-radius:var(--border-radius, 0);height:100%;overflow-x:none;overflow-y:auto}dope-menu{height:100%}\n\n/*# sourceMappingURL=data:application/json;base64, */</style><div class=\"field\" tabindex$=\"[[tabindex]]\" focused$=\"[[focused]]\" empty$=\"[[empty]]\" readonly$=\"[[readonly]]\" required$=\"[[required]]\" invalid$=\"[[invalid]]\" on-focus=\"onFocus\" on-blur=\"onBlur\"><dope-menu items=\"[[toMenuItems(formatter, items, required, placeholder)]]\" on-choose=\"onMenuChoose\" selected-index=\"{{selectedIndex}}\"></dope-menu></div>";
