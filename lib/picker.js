...
const view = "<style>:host{display:inline-block;vertical-align:middle}.wrapper{outline:none;--outline: none;min-width:var(--min-width, 6rem);background:var(--background-color, #fff)}dope-drop-down{--height: var(--dropdown-height)}\n\n/*# sourceMappingURL=data:application/json;base64, */</style><div class=\"wrapper\" tabindex$=\"[[tabindex]]\" on-click=\"activate\" on-focus=\"onFocus\" on-blur=\"onBlur\"><dope-drop-down formatter=\"[[formatter]]\" placeholder=\"[[placeholder]]\" value=\"[[value]]\" opened=\"[[focused]]\"><template body=\"body\"></template></dope-drop-down></div>";
const defaults = {
  slot: 'body',
  tabindex: '[[tabindex]]',
