...
const view = "<style>:host{display:inline-block;outline:var(--outline)}.wrapper{display:flex;height:var(--height, 14rem)}dope-time-field,dope-date-field{outline:none}dope-time-field{flex-basis:var(--time-width, 5rem);flex-grow:0;flex-shrink:0}dope-date-field{flex:1}\n\n/*# sourceMappingURL=data:application/json;base64, */</style><div class=\"wrapper\"><dope-date-field value=\"{{dateValue}}\" dirty=\"{{dateDirty}}\" focused=\"{{dateFocused}}\" required=\"[[required]]\"></dope-date-field><dope-time-field value=\"{{timeValue}}\" dirty=\"{{timeDirty}}\" focused=\"{{timeFocused}}\" required=\"[[required]]\"></dope-time-field></div>";
